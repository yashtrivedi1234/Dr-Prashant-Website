  ...
  <div className="bg-gradient-to-r from-[rgb(26,79,171)] to-[rgb(40,100,200)] text-white py-2">
    ...
    <div className="block sm:hidden px-4 space-y-2">
      ...
      <a
        ...
        className="flex items-center justify-between md:justify-start bg-white text-primary px-4 py-2 rounded-lg shadow-sm"
      >
        <span className="flex items-center gap-2 font-semibold text-sm">
          <Phone size={16} />
          Enquiry Now
        </span>
        <span className="text-lg font-bold md:ml-2">+91 80817 73201</span>
      </a>
    ...
    <div className="hidden sm:flex max-w-7xl mx-auto flex-wrap justify-between items-center gap-2 px-4 sm:px-6 md:px-8">
      <div className="flex items-center gap-3 sm:gap-4 min-w-0">
        <a
          href="tel:+918081773201"
          className="flex items-center gap-1.5 hover:opacity-80 text-sm whitespace-nowrap"
        >
          <Phone size={14} />
          +91 80817 73201
        </a>
