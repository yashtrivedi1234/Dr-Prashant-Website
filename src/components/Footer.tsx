...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-primary-foreground/10 py-6 text-center relative z-10">
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="container-main flex items-center justify-center gap-3 flex-wrap"
        >
          {" "}
